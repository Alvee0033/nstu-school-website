...
async function main() {
  ...
  const schoolInfo = await prisma.schoolInfo.upsert({
    ...
    create: {
      ...
      eiin: '123456',
      emis: '789012',
      historyEn: 'NSTU Model School was established in 2018 to provide standard education in Noakhali.',
      historyBn: 'নোবিপ্রবি মডেল স্কুল নোয়াখালী অঞ্চলের শিক্ষার্থীদের মানসম্মত শিক্ষা প্রদানের লক্ষ্যে ২০১৮ সালে প্রতিষ্ঠিত হয়।',
