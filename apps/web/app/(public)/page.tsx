...
export const metadata: Metadata = {
  title: 'Home',
  description:
    'নতুন কুঁড়ি হাই স্কুল — নোয়াখালী বিজ্ঞান ও প্রযুক্তি বিশ্ববিদ্যালয় ক্যাম্পাসের একটি আধুনিক শিক্ষা প্রতিষ্ঠান।',
};
            ...
            <div className={styles.welcomeContent}>
              ...
              <div className={styles.quoteBlock}>
                ...
                <p className={styles.welcomeText}>
                  নতুন কুঁড়ি হাই স্কুল প্রতিটি শিক্ষার্থীর সুপ্ত প্রতিভা বিকাশ এবং একটি উন্নত, মানবিক ও বিজ্ঞানমনস্ক ভবিষ্যৎ প্রজন্ম গড়ে তুলতে প্রতিশ্রুতিবদ্ধ। আমরা বিশ্ববিদ্যালয় মানের শিক্ষা, আধুনিক ডিজিটাল ল্যাব ও অত্যন্ত দক্ষ শিক্ষক মণ্ডলীর সাহায্যে পাঠদান নিশ্চিত করি। আমাদের লক্ষ্য কেবল প্রাতিষ্ঠানিক সাফল্য নয়, বরং নৈতিক মূল্যবোধের সঠিক সংমিশ্রণে শিক্ষার্থীদের সুনাগরিক হিসেবে গড়ে তোলা।
                </p>
              </div>

              <div className={styles.welcomeAuthor}>
                <strong>প্রফেসর ড. মুহাম্মদ আলম</strong>
                <span>প্রধান শিক্ষক, নতুন কুঁড়ি হাই স্কুল</span>
              </div>
      ...
      <section className={styles.highlightsSection} aria-labelledby="highlights-heading">
        <div className="container">
          <header className={styles.sectionHeaderCentered}>
            ...
            <h2 id="highlights-heading" className={styles.sectionTitle}>কেন নতুন কুঁড়ি হাই স্কুল?</h2>
