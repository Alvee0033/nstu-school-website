...
function getFallbackInfo(): SchoolInfo {
  return {
    ...
    eiin: '১২৮৫৪৩',
    emis: '৬০৯১২',
    historyBn: 'নোয়াখালী বিজ্ঞান ও প্রযুক্তি বিশ্ববিদ্যালয় (নোবিপ্রবি) ক্যাম্পাস সংলগ্ন স্থানে নোয়াখালী অঞ্চলের শিক্ষার্থীদের মাঝে মানসম্মত শিক্ষার আলো ছড়িয়ে দিতে এবং বিজ্ঞানমনস্ক নৈতিক মূল্যবোধসম্পন্ন প্রজন্ম গড়ে তোলার মহান ব্রত নিয়ে নতুন কুঁড়ি হাই স্কুল প্রতিষ্ঠিত হয়। বিশ্ববিদ্যালয় পরিচালনা পর্ষদের নিবিড় তত্ত্বাবধানে অভিজ্ঞ ও দক্ষ শিক্ষক মণ্ডলী দ্বারা নিয়মিত পাঠদান কার্যক্রম পরিচালিত হয়ে আসছে। স্কুলটিতে রয়েছে আধুনিক মাল্টিমিডিয়া ক্লাসরুম, উন্নত বিজ্ঞানাগার ও সমৃদ্ধ লাইব্রেরি যা শিক্ষার্থীদের সুপ্ত প্রতিভার বিকাশে গুরুত্বপূর্ণ অবদান রাখছে।',
